...
#flags.DEFINE_string('fps', '8', 'fps')
flags.DEFINE_string('fps', '10', 'fps')
#flags.DEFINE_string('fps', '16', 'fps')
...
#    canvas4 = np.zeros((800,800))
    import cv2
    window_name4 = 'stylegan3_cons'
    cv2.namedWindow(window_name4, cv2.WND_PROP_FULLSCREEN)
#    cv2.setWindowProperty('stylegan3_cons', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.setWindowProperty('stylegan3_cons', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_NORMAL)
    window_fullscreen4 = False
    screen4 = pf.screen(canvas4, window_name4)
...
#    if True:
      files_path = [
                ['1UP200H32RIvVYA_9TduGqIbvqfsFjpkg', 'sg3-model/', 'stylegan3-anime-faces-generator_akiyamasho', '.pkl', 'sg3_model'],#0
                ['1aMsP1juT3DzZpbEhcNWO_gJVw9lt7Ant', 'sg3-model/', 'stylegan3-r-afhqv2-512x512', '.pkl', 'sg3_model'],#1
                ['1Buunx_0kHIWdNWqRq6CBG0ILlAlcPVOb', 'sg3-model/', 'stylegan3-r-ffhq-1024x1024', '.pkl', 'sg3_model'],#2
                ['1YiCvVqosdRwta3qwMQHNAzuSRGKnSRp1', 'sg3-model/', 'stylegan3-r-ffhqu-256x256', '.pkl', 'sg3_model'],#3
                ['1z42DkzZUFhMpuWFHtMNvD6GApcL1lwG7', 'sg3-model/', 'stylegan3-r-ffhqu-1024x1024', '.pkl', 'sg3_model'],#4
                ['1BOln2JzcatBT6LTqbsdmrwVb8GJzvhNa', 'sg3-model/', 'stylegan3-r-metfaces-1024x1024', '.pkl', 'sg3_model'],#5
                ['1lh8nIxnX-xmBuu1QQokfFPBvZQPXEo0e', 'sg3-model/', 'stylegan3-r-metfacesu-1024x1024', '.pkl', 'sg3_model'],#6
                ['18ZAuZj9fWwbHx07RB8COJsepnOYtyHli', 'sg3-model/', 'stylegan3-t-afhqv2-512x512', '.pkl', 'sg3_model'],#7
                ['14OyRIEfpvhKkHooMpCKnzM3cDkOTXr6p', 'sg3-model/', 'stylegan3-t-ffhq-1024x1024', '.pkl', 'sg3_model'],#8
                ['1Yb5Cvf2DQ57-hX37gc4dq_Mo2UFMetnw', 'sg3-model/', 'stylegan3-t-ffhqu-256x256', '.pkl', 'sg3_model'],#9
                ['1XwObqI_egXDiKXoEaCn83utVEzM7Miln', 'sg3-model/', 'stylegan3-t-ffhqu-1024x1024', '.pkl', 'sg3_model'],#10
                ['1DH6C87Xr5wSG5mPZ8Y9GZgymsgBMTzMP', 'sg3-model/', 'stylegan3-t-metfaces-1024x1024', '.pkl', 'sg3_model'],#11
                ['11Mn6U-mcJulhSzUetwX1Q03h7EXrZxS_', 'sg3-model/', 'stylegan3-t-metfacesu-1024x1024', '.pkl', 'sg3_model'],#12
                ['1Ncs7wUsbfSEPJCcxiTLDOYjLT6UY9wT2', 'sg3-model/', 'sg3_alien-sunglases-256_network-snapshot-000074', '.pkl', 'sg3_model'],#13
                ['1CtKjqv7Te5X3L0KuZLIbzi7fbmpLakYS', 'sg3-model/', 'sg3_Benches-512_network-snapshot-011000', '.pkl', 'sg3_model'],#14
                ['15LkW8nCsVRrzjjYTVGlUJSnfGDi1RwyI', 'sg3-model/', 'sg3_flowers-256_network-snapshot-000069', '.pkl', 'sg3_model'],#15
                ['1RcmJNbWy9As2OMVGiVhMFM0qUKCYB1IK', 'sg3-model/', 'sg3_Landscapes_lhq-256-stylegan3-t-25Mimg', '.pkl', 'sg3_model'],#16
                ['1iO_T0MvNw59MPAueoqUHKzpoh40vyLrZ', 'sg3-model/', 'sg3_mechanical-devices-from-the-future-256_network-snapshot-000029', '.pkl', 'sg3_model'],#17
                ['1mMZSFynUd_6AIuC8PkDWdeHWY4VyIqYm', 'sg3-model/', 'sg3_scifi-city-256_network-snapshot-000210', '.pkl', 'sg3_model'],#18
                ['14DpmYfsX3K9JhkS0BV5YtgZ71wJOInsd', 'sg3-model/', 'sg3_scifi-spaceship-256_network-snapshot-000162', '.pkl', 'sg3_model'],#19
                ['13Q5bDnng7VfqYq6g-t8jVybR-E_Df_q3', 'sg3-model/', 'sg3_wikiart-1024-stylegan3-t-17.2Mimg', '.pkl', 'sg3_model'],#20
                ['10Q6npsBKdRWMb0LxZUzN6FBSNeB4KTA6', 'sg3-model/', 'sg3_yellow-alien-512_network-snapshot-000236', '.pkl', 'sg3_model'],#21
                ['10l7ADbHmZgjSrrpNzOD8r5grJqwxfRd3', 'sg3-model/', 'stylegan3_sneaksnap', '.pkl', 'sg3_model']#22
                 ]
...
#          ['', 'model/aydao-anime-danbooru2019s-512-5268480.pt', 'sg2-ada_2020-01-11-skylion-stylegan2-animeportraits-networksnapshot-024664','ckpt'],
                   ]
      if show_game_cons:
    ...
    for i in range(len(files_path)):
      ...
      if files_path[i][3] == 'ckpt':
        if not os.path.isdir('stylegan2-rosinality-pytorch'):
          os.system('git clone https://github.com/rosinality/stylegan2-pytorch.git stylegan2-rosinality-pytorch')
        sys.path.insert(0, 'stylegan2-rosinality-pytorch')
        args_size = 512
        args_ckpt = files_path[i][1]
        args_latent = 512
        args_n_mlp = 4
        args_channel_multiplier = 2
        from model import Generator
        g_ema = Generator(
          args_size, args_latent, args_n_mlp, channel_multiplier=args_channel_multiplier
        ).to(device)
        checkpoint = torch.load(args_ckpt)
        g_ema.load_state_dict(checkpoint["g_ema"])
        G3ms[i] = g_ema.to(device)
      else:
        sys.path.insert(0, 'stylegan3-nvlabs-pytorch')
#    sys.path.insert(0, '/content/stylegan3-Expl0dingCat-pytorch')
...
#              break  # if user pressed a key other than the given key the loop will break
        ...
        if show_stylegan3_cons:
                ...
                if cv2.waitKey(1) == 27:
                  if window_fullscreen4:
                    cv2.setWindowProperty(window_name4, cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_NORMAL)
                    window_fullscreen4 = False
                  else:
                    cv2.setWindowProperty(window_name4, cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
                    window_fullscreen4 = True
...
#                  myimage = buffer.getvalue()   
                  ...
                  if FLAGS.write_video:
                    video_out.append_data(image)
                  image = image[:,:,::-1]
                  window_rect4 = cv2.getWindowImageRect(window_name4)
#                  print(window_rect4)
